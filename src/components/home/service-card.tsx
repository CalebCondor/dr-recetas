      ...
      <Link href={href} className="block h-full">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-10 z-30">
          <div className="flex flex-col gap-4">
            ...
            <div className="pt-2">
              <div className="group/btn relative w-full flex items-center justify-between px-6 py-4 rounded-3xl font-bold text-sm transition-colors duration-300 shadow-lg bg-white/20 backdrop-blur-xl text-white border border-white/20 hover:bg-white/30">

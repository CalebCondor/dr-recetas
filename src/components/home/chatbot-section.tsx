    ...
    <section id="chatbot" className="relative w-full py-16 lg:py-24 overflow-hidden">
      <div className="w-full h-[808px] md:h-[927px] max-w-400 mx-auto">
        ...
        <div className="relative h-[748px] md:h-[927px] w-full rounded-[2.5rem] md:rounded-[5rem] overflow-hidden bg-[#1E3A2F] shadow-2xl group">
          ...
          {/* Layout Grid */}
          <div className="relative h-full w-full z-20 flex flex-col md:grid md:grid-cols-3 items-center md:items-stretch px-6 md:px-16 lg:px-24 pt-12 md:pt-12 pb-0 md:pb-0 gap-8 md:gap-12 text-white">

            {/* Left Content - Order 1 on Mobile */}
            <div className="flex flex-col justify-center text-center md:text-left order-1 md:order-1 md:-translate-y-40">
              <motion.h2
            ...
            {/* Right Content - Order 2 on Mobile (Description) */}
            <div className="flex flex-col justify-center items-center md:items-start md:pl-8 text-center md:text-left order-2 md:order-3 z-30 md:-translate-y-40">
              <motion.div
                initial={{ opacity: 0, x: 30 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.8 }}
            ...
            {/* Spacer for the central area in the grid */}
            <div className="relative h-[200px] md:h-full w-full order-3 md:order-2 pointer-events-none" />
